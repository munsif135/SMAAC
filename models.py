...
class GATLayer(nn.Module):
    def __init__(self, output_dim, nheads, dropout=0): # output_dim = 128, nheads = 8 , dropout = 0.
...
class EncoderLayer(nn.Module):
    def __init__(self, input_dim, output_dim, nheads, node, dropout=0): # input_dim = 30, output_dim = 128, nheads = 8 , node = 177, dropout = 0.
